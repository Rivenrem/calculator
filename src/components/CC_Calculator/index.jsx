...
import Display from "Components/CC_Display/index.jsx";
import Keypad from "Components/CC_Keypad/index.jsx";
import History from "Components/CC_History/index.jsx";
import ControlPanel from "Components/CC_ControlPanel/index.jsx";
...
import { Container, CalcContainer } from "Components/CC_Calculator/styled.js";

class CC_Calculator extends Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps)(CC_Calculator);
